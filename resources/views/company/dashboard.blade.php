                        ...
                        <div class="card bg-globe-img">
                            <div class="card-body">
                                <div>
                                    ...
                                    <h4 class="my-2 fs-24 fw-semibold text-success">GHS 122.5692.00 <small class="font-14"></small></h4>                                            
                                            ...
                                            <div class="col-md-4">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row d-flex justify-content-center">
                                                            <div class="col-9">
                                                                <p class="text-muted text-uppercase mb-0 fw-normal fs-13">Pending</p>
                                                                <h5 class="mt-1 mb-0 fw-medium">2</h5>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3 align-self-center">
                                                                <div class="d-flex justify-content-center align-items-center thumb-md rounded mx-auto">
                                            ...
                                            <div class="col-md-4">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row d-flex justify-content-center">
                                                            <div class="col-9">
                                                                <p class="text-muted text-uppercase mb-0 fw-normal fs-13">Completed</p>
