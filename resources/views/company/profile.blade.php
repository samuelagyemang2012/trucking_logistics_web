                                ...
                                <div class="d-flex align-items-center">
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute top-50 start-100 translate-middle">
                                            <img src="{{asset('images/flags/baha_flag.jpg')}}" alt=""
                            ...
                            <div class="col-lg-12">
                                <div class="mt-3">
                                    <div class="text-body mb-2  d-flex align-items-center"><i
                                            class="iconoir-map-pin fs-20 me-1 text-muted"></i><span
                                            class="text-body fw-semibold">Address :</span>&nbsp;1 Logoligi Street, Accra</div>
                                    <div class="text-muted mb-2 d-flex align-items-center"><i
                                            ...
                                            class="text-primary text-decoration-underline"> &nbsp;example@example.com</a></div>
                                    <div class="text-body mb-3 d-flex align-items-center"><i
                                            class="iconoir-phone fs-20 me-1 text-muted"></i><span
                                            class="text-body fw-semibold">Phone :</span>&nbsp; +1 123 456 789</div>
                                    <div class="text-body mb-3 d-flex align-items-center"><i
                                            class="iconoir-phone fs-20 me-1 text-muted"></i><span
                                            class="text-body fw-semibold">TIN :</span>&nbsp; 1-123-456-789</div>
                                    <button type="button" class="btn btn-warning  d-inline-block rounded-pill">Edit Profile</button>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class=""><i class="las la-birthday-cake me-2 text-secondary fs-22 align-middle"></i>
                                <b> Birth Date </b> : 06 June 1989</li>
                            <li class="mt-2"><i class="las la-briefcase me-2 text-secondary fs-22 align-middle"></i> <b>
                                    Position </b> : Full Stack Developer</li>
                            <li class="mt-2"><i class="las la-university me-2 text-secondary fs-22 align-middle"></i> <b>
                                    Education </b> : Stanford Univercity</li>
                            <li class="mt-2"><i class="las la-language me-2 text-secondary fs-22 align-middle"></i> <b>
                                    Languages </b> : English, French, Spanish</li>
                            ...
                            <li class="mt-2"><i class="las la-envelope text-secondary fs-22 align-middle me-2"></i> <b>
                                    Email </b> : mannat.theme@gmail.com</li>
                        </ul>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row d-flex justify-content-center">
                                            <div class="col">
                                                <p class="text-dark mb-1 fw-semibold">Trucks</p>
                                                <h3 class="my-2 fs-24 fw-bold">12</h3>
                                                {{-- <p class="mb-0 text-truncate text-muted"><i
                                                        class="iconoir-bell text-warning fs-18"></i>
                                                    <span class="text-dark fw-semibold">1500</span> New subscribers this
                                                    week
                                                </p> --}}
                                            </div>
                                            <div class="col-auto align-self-center">
                                                <div
                                                    ...
                                                    <i class="iconoir-truck fs-30 align-self-center text-muted"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!--end card-body-->
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <div class="d-flex align-items-center">
                                                    {{-- <img src="assets/images/users/avatar-10.jpg"
                                                        class="thumb-md align-self-center rounded-circle" alt="..."> --}}
                                                    <div class="flex-grow-1 ms-2">
                                                        <h5 class="m-0 fs-14">Manage Trucks</h5>
                                            ...
                                            <div class="col-auto">
                                                {{-- <div class="d-none d-sm-inline-block align-self-center">
                                                    <a href="" class="me-2 text-muted" data-bs-toggle="tooltip"
                                                        data-bs-placement="top" data-bs-title="Call"
                                                        data-bs-custom-class="tooltip-primary"><i
                                                            class="iconoir-media-image fs-18"></i></a>
                                                    <a href="" class="me-2 text-muted" data-bs-toggle="tooltip"
                                                        data-bs-placement="top" data-bs-title="Attachment"
                                                        data-bs-custom-class="tooltip-primary"><i
                                    ...
                                    <div class="card-body pt-0">
                                        <form action="">
                                            <div class="">
                                                ...
                                                <button type="button" class="btn btn-dark rounded-pill">Manage Fleet</button>
                                            </div>
                                        </form>
                                    </div><!--end card-body-->
                                </div><!--end card-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="post-title mt-3">
                                            <div class="row">
                                                ...
                                                <div class="col-auto">
                                                    <span class="text-muted"><i class="far fa-calendar me-1"></i>02 July
                                                        2024</span>
                                                </div><!--end col-->
                                            </div><!--end row-->

                                            <h5 href="#" class="fs-20 fw-bold d-block my-3">There is nothing more
                                                beautiful than nature.</h5>
                                            <span class="fs-15 bg-light py-2 px-3 rounded">Taking pictures is savouring
                                                life intensely.</span>
                                            <p class="fs-15 mt-3">It is a long established fact that a reader will be
                                            ...
                                            <blockquote class="blockquote border-start ps-4">
                                                <p class="fs-18"><i>"Lorem ipsum dolor sit amet, consectetur adipiscing
                                                        elit. Integer posuere erat a ante."</i></p>
                                                <footer class="blockquote-footer mt-1">Someone famous in <cite
                                                        title="Source Title">Source Title</cite></footer>
                                            </blockquote>
                                            <p class="fs-15">Taking pictures is savouring life intensely, every hundredth
                                                of a second – Marc Riboud.
                                                Joy in looking and comprehending is nature’s most beautiful gift.</p>
                                            <p class="fs-15 mb-0">It is a long established fact that a reader will be
                                                distracted by the readable content of
                                                a page when looking at its layout. The point of using Lorem Ipsum is that it
                                                has a
                                                more-or-less normal distribution of letters, as opposed to using
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-auto">
                                                                    <span class="text-muted"><i
                                                                            class="far fa-clock me-1"></i>30 min ago</span>
                                                                </div><!--end col-->
                                                            </div><!--end row-->
                                                        ...
                                                        <div class="row mt-3">
                                                            ...
                                                            <div class="col">
                                                                <div class="bg-light rounded ms-n2 bg-light-alt p-3">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <p class="text-dark fw-semibold mb-2">Metrica
                                                                                Author</p>
                                                                        </div><!--end col-->
                                                                        <div class="col-auto">
                                                                            <span class="text-muted"><i
                                                                                    class="far fa-clock me-1"></i>37 min
                                                                                ago</span>
                                                                        </div><!--end col-->
                                                                    </div><!--end row-->
                                                                    <p>It is a long established fact that a reader will be
                                                    ...
                                                    <div class="col">
                                                        <div class="bg-light rounded ms-n2 bg-light-alt p-3">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-auto">
                                                                    <span class="text-muted"><i
                                                                            class="far fa-clock me-1"></i>40 min ago</span>
                                                                </div><!--end col-->
                                                            </div><!--end row-->
