            ...
            <div class="startbar-collapse" id="startbarCollapse" data-simplebar>
                <div class="d-flex align-items-start flex-column w-100">
                    ...
                    <ul class="navbar-nav mb-auto w-100">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarTransactions">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="transactions.html">All</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="transactions.html">Pending</a>
                                    </li><!--end nav-item-->
                                    <li class="nav-item">
                                        <a class="nav-link" href="new-transaction.html">Completed</a>
                                    </li><!--end nav-item-->
                                </ul><!--end nav-->
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/fleet/all">
