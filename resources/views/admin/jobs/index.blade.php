...
{{--                                        data-bs-target="#addAdmin"><i class="fas fa-plus me-1"></i> Add New Job</button>--}}
{{--                                </div>--}}
{{--                            </div><!--end col-->--}}
{{--                        </div> <!--end row-->--}}
{{--                    </div><!--end card-header-->--}}
...
{{--                                            <td>{{ $job->price }}</td>--}}
{{--                                            <td>{{ $job->insurance_package }}</td>--}}

{{--                                            <td class="">--}}
{{--                                                <a href="{{ route('admin.jobs.show', $job->id) }}" class="btn btn-sm btn-primary"--}}
...
{{--                                    <input type="number" name="number_of_vehicles" class="form-control" placeholder="1" required>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                    <input type="number" step="0.01" name="price" class="form-control" placeholder="e.g. 150.00">--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                    <input type="text" name="pickup_point" class="form-control" placeholder="Pickup location" required>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                    <input type="text" name="destination_point" class="form-control" placeholder="Destination location" required>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                    <input type="number" step="0.01" name="breadth" class="form-control" placeholder="Breadth">--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                    <input type="text" name="insurance_package" class="form-control" placeholder="Optional">--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                    <textarea name="decline_reason" class="form-control" rows="2" placeholder="Reason if declined"></textarea>--}}
{{--                                </div>--}}
{{--                            </div>--}}
